...
# ================= 1. CẤU HÌNH DASHBOARD & CSS THU GỌN LỀ =================
st.set_page_config(
...
st.markdown(
    ...
    <style>
        ...
        /* Triệt tiêu padding thừa, kéo sát mép trên */
        ...
        /* Nút Navigation Tabs Căn Giữa Giống Ảnh Gốc */
        ...
        /* Chỉ đóng khung Card cho container chứa biểu đồ (Tránh ô trắng thừa) */
        .chart-card {
...
# Cấu hình Matplotlib Chuẩn HD & Font Tránh Lỗi Findfont
...
COLOR_SUCCESS = "#10B981"  # Xanh lá (Đạt / SL Hoàn thành)
COLOR_PRIMARY = "#3B82F6"  # Xanh dương (Lệnh / Hàng về)
COLOR_DANGER = "#EF4444"  # Đỏ (Lỗi / Bị Block / Lệnh chưa xong)
...
with tab_vat_tu:
  if df_qa32.empty:
    ...
    with col1:
      ...
      fig1 = plt.figure(figsize=(8.2, 3.2), dpi=180)
...
# ================= 5. HÀM CHUNG BÁO CÁO COOIS (CÂN ĐỐI 100% CÁC KHUNG BIỂU ĐỒ) =================
def render_coois_tab_layout(phan_he_code, title_text):
  ...
  with col1:
    st.markdown('<div class="chart-card">', unsafe_allow_html=True)
    fig1, ax1 = plt.subplots(figsize=(7.8, 3.1), dpi=180)
    fig1.patch.set_facecolor(Theme.SURFACE)
    ax1.set_facecolor(Theme.SURFACE)
    ax2 = ax1.twinx()
  ...
  with col2:
    st.markdown('<div class="chart-card">', unsafe_allow_html=True)
    fig2, ax3 = plt.subplots(figsize=(3.8, 3.1), dpi=180)
  ...
  # HÀNG 2: BỘ LỌC ĐẶT NGOÀI & 2 ĐỒ THỊ BÊN DƯỚI THẲNG HÀNG tuyệt ĐỐI
  sub_5 = (
      df_sub[
          df_sub["ma_tp"]
          .astype(str)
  ...
  # Bộ Lọc Dòng SP Đặt Trực Tiếp (Triệt tiêu ô trắng thừa)
